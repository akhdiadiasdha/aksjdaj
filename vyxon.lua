...
-- -- second PlayersTab
-- local theme = Vyxon:addPage("Theme", 5012544693)
...
--         color,
--         function(color3)
--             Vyxon:setTheme(theme, color3)
--         end
--     )
-- end

-- load
-- Vyxon:SelectPage(Vyxon.pages[1], true) -- no default for more freedom
