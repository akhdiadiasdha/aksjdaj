...
local Button_Icon = "rbxassetid://117153053780578" -- Icon of the button for toggle fluent ui
----------------------------
...
local Themes = {
	...
	PurpleGalaxy = {
		...
		InElementBorder = Color3.fromRGB(140, 80, 200),
		ElementTransparency = 1,
		ToggleSlider = Color3.fromRGB(210, 200, 255),
		ToggleToggled = Color3.fromRGB(110, 0, 180),
		SliderRail = Color3.fromRGB(220, 210, 255),
		DropdownFrame = Color3.fromRGB(250, 245, 255),
		DropdownHolder = Color3.fromRGB(20, 10, 35),
		DropdownBorder = Color3.fromRGB(160, 100, 255),
		DropdownOption = Color3.fromRGB(230, 220, 255),
		Keybind = Color3.fromRGB(255, 255, 255),
		Input = Color3.fromRGB(240, 235, 255),
		InputFocused = Color3.fromRGB(60, 0, 100),
	...
	BlueWhite = {
		Name = "BlueWhite",
		Accent = Color3.fromRGB(0, 120, 255), -- Vivid Blue
		AcrylicMain = Color3.fromRGB(20, 20, 35), -- Deep navy blue
		AcrylicBorder = Color3.fromRGB(255, 255, 255), -- Dark blue border
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 30, 60), Color3.fromRGB(40, 60, 100)), -- Cool blue gradient
		AcrylicNoise = 0.9,
		TitleBarLine = Color3.fromRGB(0, 90, 200), -- Bright blue line
		Tab = Color3.fromRGB(220, 230, 255), -- Soft blue-white
		Element = Color3.fromRGB(255, 255, 255), -- Pure white
		ElementBorder = Color3.fromRGB(255, 255, 255), -- Blue border
		InElementBorder = Color3.fromRGB(255, 255, 255), -- Lighter blue
		ElementTransparency = 1,
		ToggleSlider = Color3.fromRGB(230, 240, 255), -- Soft faded white-blue
		ToggleToggled = Color3.fromRGB(0, 60, 160), -- Deep toggled blue
		SliderRail = Color3.fromRGB(230, 240, 255),
		DropdownFrame = Color3.fromRGB(255, 255, 255), -- White dropdown background
		DropdownHolder = Color3.fromRGB(15, 25, 50), -- Dark blue holder
		DropdownBorder = Color3.fromRGB(255, 255, 255), -- Accent blue border
		DropdownOption = Color3.fromRGB(230, 240, 255),
		Keybind = Color3.fromRGB(255, 255, 255),
		Input = Color3.fromRGB(240, 245, 255),
		InputFocused = Color3.fromRGB(0, 30, 90), -- Dark navy on focus
		InputIndicator = Color3.fromRGB(0, 150, 255),
		InputIndicatorFocus = Color3.fromRGB(255, 255, 255),
		Dialog = Color3.fromRGB(25, 30, 60),
		DialogHolder = Color3.fromRGB(20, 25, 50),
		DialogHolderLine = Color3.fromRGB(0, 90, 180),
		DialogButton = Color3.fromRGB(0, 130, 255), -- Strong blue
		DialogButtonBorder = Color3.fromRGB(255, 255, 255), -- White border
		DialogBorder = Color3.fromRGB(255, 255, 255),
		DialogInput = Color3.fromRGB(240, 245, 255),
	...
	RedWhite = {
		...
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(25, 0, 0), Color3.fromRGB(80, 0, 0)), -- Faded dark red gradient
		AcrylicNoise = 0.9,
		TitleBarLine = Color3.fromRGB(90, 0, 0), -- Deep red line
		Tab = Color3.fromRGB(200, 200, 200), -- Soft white
		Element = Color3.fromRGB(255, 255, 255), -- White
		ElementBorder = Color3.fromRGB(100, 0, 0), -- Red border
		InElementBorder = Color3.fromRGB(180, 50, 50), -- Light red
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(240, 240, 240), -- Faded white
		ToggleToggled = Color3.fromRGB(130, 0, 0), -- Dark red toggle
		SliderRail = Color3.fromRGB(240, 240, 240),
		DropdownFrame = Color3.fromRGB(255, 255, 255), -- White background
		DropdownHolder = Color3.fromRGB(30, 0, 0), -- Dark red holder
		DropdownBorder = Color3.fromRGB(80, 0, 0), -- Red border
		DropdownOption = Color3.fromRGB(240, 240, 240),
		Keybind = Color3.fromRGB(255, 255, 255),
		Input = Color3.fromRGB(240, 240, 240),
		InputFocused = Color3.fromRGB(20, 0, 0), -- Dark red when focused
		InputIndicator = Color3.fromRGB(220, 0, 0),
		InputIndicatorFocus = Color3.fromRGB(180, 0, 0),
		Dialog = Color3.fromRGB(35, 0, 0),
		DialogHolder = Color3.fromRGB(25, 0, 0),
		DialogHolderLine = Color3.fromRGB(60, 0, 0),
		DialogButton = Color3.fromRGB(200, 0, 0), -- Bright red button
		DialogButtonBorder = Color3.fromRGB(255, 255, 255), -- White border
	...
	VYXON2 = {
		...
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(25, 0, 0), Color3.fromRGB(50, 0, 0)), -- Gradient with dark red
		AcrylicNoise = 1,
		TitleBarLine = Color3.fromRGB(255, 255, 255), -- White title bar line for contrast
		Tab = Color3.fromRGB(30, 0, 0), -- Dark red for the tab background
		Element = Color3.fromRGB(20, 0, 0), -- Dark red for elements
		ElementBorder = Color3.fromRGB(255, 255, 255), -- White border for elements
		InElementBorder = Color3.fromRGB(255, 255, 255), -- White inner border for elements
		ElementTransparency = 0.95, -- Slight transparency for a smooth effect
		ToggleSlider = Color3.fromRGB(30, 0, 0), -- Dark red slider
		ToggleToggled = Color3.fromRGB(255, 255, 255), -- White when toggled
		SliderRail = Color3.fromRGB(30, 0, 0), -- Dark red slider rail
		DropdownFrame = Color3.fromRGB(30, 0, 0), -- Dark red for dropdown frame
		DropdownHolder = Color3.fromRGB(10, 0, 0), -- Darker red for dropdown holder
		DropdownBorder = Color3.fromRGB(255, 255, 255), -- White border for dropdown
		DropdownOption = Color3.fromRGB(30, 0, 0), -- Dark red option for dropdown
		Keybind = Color3.fromRGB(30, 0, 0), -- Dark red for keybinds
		Input = Color3.fromRGB(30, 0, 0), -- Dark red for input fields
		InputFocused = Color3.fromRGB(20, 0, 0), -- Darker red when focused
		InputIndicator = Color3.fromRGB(255, 255, 255), -- White input indicator
		InputIndicatorFocus = Color3.fromRGB(255, 255, 255), -- White when focused
		Dialog = Color3.fromRGB(20, 0, 0), -- Dark red dialog background
		DialogHolder = Color3.fromRGB(30, 0, 0), -- Dark red for dialog holder
		DialogHolderLine = Color3.fromRGB(255, 255, 255), -- White line in dialog holder
		DialogButton = Color3.fromRGB(30, 0, 0), -- Dark red for buttons
		DialogButtonBorder = Color3.fromRGB(255, 255, 255), -- White button border
		DialogBorder = Color3.fromRGB(255, 255, 255), -- White border for the dialog
		DialogInput = Color3.fromRGB(30, 0, 0), -- Dark red input field in dialog
...
ElementsTable.Paragraph = (function()
	...
	function Paragraph:New(Config)
		...
		Paragraph.Frame.BackgroundTransparency = 0.95
